...
//        txtUserType.setText(sharedPreferences.getString("UserType","Teste"));
        txtUserType.setText(getString(R.string.paciente));
...
//                intent.setType("image/*");
        ...
        // Opção Lembretes
        CardView mMemo = rootView.findViewById(R.id.cvLembretes);
        mMemo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
//                mCallback.onOptionSelected("Memo");
                Intent intent = new Intent(getContext(), ActivityMemo.class);
