        ...
        switch (option) {
            case "ToDo": {
                fragmentManager.beginTransaction()
                        .replace(R.id.container, new fragment_ToDo())
                        .commit();
                break;
            }
            case "Memo": {
...
////                        .commit();
            ...
            case "Mens": {
                fragmentManager.beginTransaction()
                        .replace(R.id.container, new fragment_Message())
                        .commit();
                break;
            }
            case "Local": {
                fragmentManager.beginTransaction()
                        .replace(R.id.container, new fragment_Location())
                        .commit();
                break;
            }
            case "Info": {
                fragmentManager.beginTransaction()
                        .replace(R.id.container, new fragment_UserInfo())
                        .commit();
                break;
            }
            case "Call": {
